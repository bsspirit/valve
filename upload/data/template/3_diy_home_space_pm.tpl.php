...
0
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_pm_node.htm', 1357447517, 'diy', './data/template/3_diy_home_space_pm.tpl.php', './template/eis_d25_024', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/common/seditor.htm', 1357447517, 'diy', './data/template/3_diy_home_space_pm.tpl.php', './template/eis_d25_024', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_prompt_nav.htm', 1357447517, 'diy', './data/template/3_diy_home_space_pm.tpl.php', './template/eis_d25_024', 'home/space_pm')
;?>
...
<span class="xi2">您</span>
<?php } else { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $value['authorid'];?>" target="_blank"><?php echo $value['author'];?></a>
<?php } ?>
 &nbsp; 
<?php } ?>
...
<?php } ?><?php $seditor = array('reply', array('bold', 'color', 'img', 'link', 'quote', 'code', 'smilies'));?><script src="<?php echo $_G['setting']['jspath'];?>seditor.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<div class="fpd">
...
<span class="xg1">共 <?php echo $value['pmnum'];?> 条</span>
</dd>
<dd class="m avt">
<div class="newpm_avt" title="有未读消息"></div>
<?php if($value['pmtype'] == 1) { ?>
...
<span class="xi2">您</span> 对 <a href="home.php?mod=space&amp;uid=<?php echo $value['touid'];?>" target="_blank"><?php echo $value['tousername'];?></a> 说 :
<?php } else { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $value['touid'];?>" target="_blank"><?php echo $value['tousername'];?></a> 对 <span class="xi2">您</span> 说 :
<?php } ?>
...
<ul>
<li <?php echo $opactives['pm'];?>><a href="home.php?mod=space&amp;do=pm">消息 <?php if($newpmcount) { ?><strong class="xi1">(<?php echo $newpmcount;?>)</strong><?php } ?></a></li>
<li <?php echo $opactives['notice'];?>><a href="home.php?mod=space&amp;do=notice">提醒</a></li>	
</ul>
</div><div class="drag">
