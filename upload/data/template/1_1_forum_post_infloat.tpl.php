...
0
|| checktplrefresh('./template/default/forum/post_infloat.htm', './template/default/common/seditor.htm', 1357441508, '1', './data/template/1_1_forum_post_infloat.tpl.php', './template/default', 'forum/post_infloat')
|| checktplrefresh('./template/default/forum/post_infloat.htm', './template/default/common/seccheck.htm', 1357441508, '1', './data/template/1_1_forum_post_infloat.tpl.php', './template/default', 'forum/post_infloat')
...
<a href="javascript:;" id="custominfo" class="y"><img src="<?php echo IMGDIR;?>/info_small.gif" alt="帮助" /></a>
<?php } ?>
<button type="submit" id="postsubmit" class="pn pnc z" value="true" name="<?php if($_GET['action'] == 'newthread') { ?>topicsubmit<?php } elseif($_GET['action'] == 'reply') { ?>replysubmit<?php } ?>" tabindex="23"><span><?php if($_GET['action'] == 'newthread') { ?>发表帖子<?php } elseif($_GET['action'] == 'reply') { ?>参与/回复主题<?php } ?></span></button>
