...
0
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_extra.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_body.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_attribute.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/seccheck.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_option.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor_menu.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/editor_menu_forum.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1357451385, '3', './data/template/3_3_forum_post.tpl.php', './template/eis_d25_024', 'forum/post')
...
<?php if($_G['group']['allowdownremoteimg']) { if(!($_G['setting']['magicstatus'] && !empty($_G['setting']['magics']['doodle']))) { } ?><a id="<?php echo $editorid;?>_downremoteimg" title="下载远程图片">下载图片</a><?php } ?>
</p>
<p>
<a id="<?php echo $editorid;?>_quote" title="添加引用文字">引用</a>
<?php if($isfirstpost) { ?><a id="<?php echo $editorid;?>_hide" title="添加隐藏内容"<?php if(!$_G['group']['allowhidecode']) { ?> style="visibility:hidden;"<?php } ?>>Hide</a><?php } if($_G['setting']['magicstatus'] && !empty($_G['setting']['magics']['doodle'])) { ?>
...
<dd><label for="rushreply"><input type="checkbox" name="rushreply" id="rushreply" class="pc vm" value="1" <?php if($_GET['action'] == 'edit' && getstatus($thread['status'], 3)) { ?>disabled="disabled" checked="checked"<?php } ?> onclick="extraCheck(3)" /> 将该帖设为抢楼帖</label></dd>
