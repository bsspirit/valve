...
0
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/home/space_prompt_nav.htm', 1357447512, 'diy', './data/template/3_diy_home_space_notice.tpl.php', './template/eis_d25_024', 'home/space_notice')
;?>
...
<li<?php echo $actives['notice'];?>><a href="home.php?mod=space&amp;do=notice">提醒</a></li>
<li<?php echo $actives['userapp'];?>><a href="home.php?mod=space&amp;do=notice&amp;view=userapp">应用消息<?php if($mynotice) { ?>(<?php echo $mynotice;?>)<?php } ?></a></li>
<?php } else { ?>
<li<?php echo $readtag['0'];?>><a href="home.php?mod=space&amp;do=notice">未读提醒</a></li>
<li<?php echo $readtag['1'];?>><a href="home.php?mod=space&amp;do=notice&amp;isread=1">已读提醒</a></li>
<?php } ?>
</ul>
...
<?php } else { if($_G['setting']['my_app_status']) { ?>
<div class="tbmu">
<?php if(!empty($list)) { ?>
<span class="y">当您感觉有些通知对您造成骚扰时，请点击右侧小图标进行屏蔽</span>
<?php } ?>
<a href="home.php?mod=space&amp;do=notice"<?php echo $readtag['0'];?>>未读提醒</a><span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=notice&amp;isread=1"<?php echo $readtag['1'];?>>已读提醒</a>
</div>
<?php } if(empty($list)) { ?>
<div class="emp mtw ptw hm xs2">
<?php if($_GET['isread'] != 1) { ?>
