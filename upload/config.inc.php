...
// [CH] 论坛安全设置, 调整以下设置，可以增强论坛的安全性能和防御性能
	...
	$adminemail = 'bsspirit@gmail.com';		// 系统管理员 Email
...
define('UC_DBUSER', 'valve');
define('UC_DBPW', 'valve');
define('UC_DBNAME', 'valve');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`valve`.cdb_uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'UdF0K12fx2haI154X8Q5g4Z9Md9478S5M7CbH86fidmcMd96jdrc600ck2A3Y5m3');
define('UC_API', 'http://loc.v.com/install/index.php/uc_server');
